...
class PostDetailView(View):
    ...
    def post(self , request , *args , **kwargs):
        ...
        if form.is_valid():
            ...
            new_comment.save()
            messages.success(request , 'commented on post' , 'success')
...
class PostAddReplyView(LoginRequiredMixin , View):
    ...
    def post(self , request , post_id , comment_id):
        ...
        if form.is_valid():
            ...
            messages.success(request , 'your replied to this post!' , 'success')
...
class PostLikeView(LoginRequiredMixin , View):
    def get(self , request , post_id):
        ...
        if like.exists():
            ...
            vote.delete()
            messages.success(request , f'{request.user}, you un like {post.user.username}' , 'success')
        else:
            Vote.objects.create(post=post , user=request.user)
            messages.success(request , f'{request.user}, you like {post.user.username}' , 'success')
