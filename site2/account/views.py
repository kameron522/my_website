...
class UserRegisterView(View):
    ...
    def dispatch(self, request, *args, **kwargs):
        if request.user.is_authenticated:
            messages.warning(request , 'You have already registered!' , 'warning')
    ...
    def post(self , request):
        ...
        if form.is_valid():
            ...
            User.objects.create_user(cd['username'].lower() , cd['email'].lower() , cd['password1'])
...
class UserLoginView(View):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if request.user.is_authenticated:
            messages.warning(request , 'You have already logged in!' , 'warning')
            return redirect('home:home')
